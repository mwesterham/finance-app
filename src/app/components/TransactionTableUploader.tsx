...
interface TransactionTableUploaderProps {
}

export default function TransactionTableUploader(props: TransactionTableUploaderProps) {
  ...
  return <>
    <div className="p-4 border rounded-lg shadow-md space-y-4 bg-white">
      <label className="font-semibold block">Transaction Table Import</label>
